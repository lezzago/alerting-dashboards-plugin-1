...
declare module '../../../src/plugins/ui_actions/public' {
  export interface ActionContextMapping {
    [ACTION_ALERTING]: AlertingActionContext;
  }
}

interface AppPluginSetupDependencies {
  dashboardDashboards: DashboardSetup;
...
export class AlertingPlugin implements Plugin< AlertingPluginPluginSetup, AlertingPluginPluginStart > {
  constructor(initializerContext) {
    // can retrieve config from initializerContext
  }

  setup(core, plugins : AppPluginSetupDependencies): AlertingPluginPluginSetup {
  ...
  start(core): AlertingPluginPluginStart {
    return {};
  }
}
